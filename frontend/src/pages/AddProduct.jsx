...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const rentalPriceNum = Number(formData.rentalPrice);
      ...
      <div className="w-full max-w-2xl bg-white border border-gray-100 shadow-sm rounded-3xl p-8 md:p-12">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-sm mt-1">
            Add gear to the ProLens rental catalog.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col">
              <label className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-2 ml-1">
                Model Name
              </label>
              <input
                type="text"
                ...
                value={formData.name}
                onChange={handleChange}
                placeholder="e.g. Sony Alpha A7"
                className="bg-transparent border-b border-gray-200 py-2 outline-none focus:border-black transition-colors"
              />
            </div>
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                onChange={handleChange}
                className="bg-transparent border-b border-gray-200 py-2 outline-none focus:border-black transition-colors appearance-none cursor-pointer"
              >
          ...
          <div className="flex flex-col">
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Key features and kit contents..."
              className="bg-transparent border-b border-gray-200 py-2 outline-none focus:border-black transition-colors resize-none h-20"
            />
          </div>
